"""
Django settings for cotacao_moedas project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', '_qr!*-x2p*^7a!ho=#r!hp28p&+4(w1=$v3qn$r8a76l&=z(w0')
...
ROOT_URLCONF = 'cotacao_moedas.urls'
...
WSGI_APPLICATION = 'cotacao_moedas.wsgi.application'
